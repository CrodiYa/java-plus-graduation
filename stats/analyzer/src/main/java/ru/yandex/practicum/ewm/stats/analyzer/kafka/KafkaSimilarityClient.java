...
public class KafkaSimilarityClient implements KafkaClient<EventSimilarityAvro> {
    ...
    public void init() {
        ...
        this.consumer.subscribe(Collections.singletonList(kafkaProperties.getTopic().getSimilarity()));
    }

    @Override
    public List<EventSimilarityAvro> pollMessages() {
